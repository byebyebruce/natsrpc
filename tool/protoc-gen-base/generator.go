...
func (d *FileDescriptor) goFileName(pathType pathType, toolName string) string {
	name := *d.Name
...
func (g *Generator) GenerateAllFiles() {
	...
	for _, file := range g.allFiles {
		...
		fname := file.goFileName(g.pathType, g.name)
		...
		if g.annotateCode {
			...
			g.Response.File = append(g.Response.File, &plugin.CodeGeneratorResponse_File{
				Name:    proto.String(file.goFileName(g.pathType, g.name) + ".meta"),
